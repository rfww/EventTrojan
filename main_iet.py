...
def FLAGS():
    ...
    # parser.add_argument("--validation_dataset", default="data/N-Cars/val", required=False)
    # parser.add_argument("--training_dataset", default="data/N-Cars/train", required=False)
    ...
    # logging options
    parser.add_argument("--log_dir", default="log/cars_uni_polarity_res18", required=False)
    # trigger pattern
...
if __name__ == '__main__':
    ...
    validation_loader = Loader(validation_dataset, flags, device=flags.device, shuffle=False)
    ...
    for i in range(flags.num_epochs):
        ...
        for events, labels,_, names, _ in tqdm.tqdm(validation_loader):
        ...
        for events, labels,_, names,_ in tqdm.tqdm(training_loader):
            events = events.to(flags.device)
            labels = labels.to(flags.device)
